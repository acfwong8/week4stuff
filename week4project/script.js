$(document).ready(function(){
	...
	// variable nameGenerated = allCohorts array [number put in input field] and [Random number genrated within specific cohort array]
	// var nameGenerated = allCohorts[cohortInput][Math.floor(Math.random()*allCohorts[cohortInput].length)];
	//old script
	...
	$(".results li").on("click", function() {
        ...
        if(allCohorts.length > 1){
            $(".favourites").addClass("maxList").animate({
                "right":"500px"
            }, 500);
        };
